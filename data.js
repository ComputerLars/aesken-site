...
window.ARKIV = [
    {
      id: "guessing-and-doing", kind: "Vinduesudstilling", title: "Guessing and Doing",
      status: "", statusLabel: "Tidligere", meta: "4.–29. september 2025",
      blurb: "Madeleine Andersson og Mandus Ridefelt om perversion og regression. En skulptur baseret på earth-bathing, en lecture performance om forholdet mellem videnskab og perversion, og en publikation med sonnetter om planetær perversion og et essay om fylogenetiske selv-eksperimenter, der kravler baglæns ind i artens forhistorie.",
      items: [ { when: "Fernisering", what: "Lecture performance: Perversion of Science" } ]
    },
    {
      id: "politiunivers", kind: "Duoudstilling", title: "Andersens og Dahlgaards Politiunivers",
      status: "", statusLabel: "Tidligere", meta: "5.–29. september 2025",
      blurb: "Sally Dalgaard og Selina Rom Andersen. Et manuskript til en tv-serie om betjentene Andersen og Dahlgaard, der patruljerer i Århus i en konstant kamp mod ikke bare de lovløse, men også loven selv. Husk, at lovens lange arm kun har fem fingre.",
      items: [ { when: "22. sep", what: "Læse-handling: Antipolitik", sub: "Olof Palme fra AI-partiet" } ]
    },
    {
    ...
    },
    {
      ...
      status: "", statusLabel: "Tidligere", meta: "August og oktober 2025",
      blurb: "To åbne læse-handle-kredse hvor antipolitik aktualiseres via et lokalt-internationalt perspektiv, med fokus på afmagt, nye alliancer, produktion og kunstnerisk vidensorganisation.",
      items: [
        { when: "14. aug", what: "Emma Bexell", sub: "SABAE og Olof Palme, kollektive læsninger, lejlighedsvidenskab" },
        { when: "16. okt", what: "James Day", sub: "Kapitallogik og antipolitisk form" }
      ]
    },
    {
      id: "faellesinstallation", kind: "Gruppeudstilling", title: "Afsluttende fællesinstallation",
      status: "", statusLabel: "Tidligere", meta: "18. december 2025",
